@section('header')
<!-- Navbar -->
<header class="site-header sticky-top py-1 bg-dark mb-5">
  <nav class="container d-flex flex-column flex-md-row justify-content-between">
    ...
    <a class="py-2 d-none d-md-inline-block" href="{{ route('about') }} ">About Us</a>
    <a class="py-2 d-none d-md-inline-block" href="{{route('contact')}}">Contact</a>
    <a class="py-2 d-none d-md-inline-block" href="{{ route('messages') }}">Messages</a>
